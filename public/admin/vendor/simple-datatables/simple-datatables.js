          ...
          (function (global) {
            (function () {
              ...
              const tt = {
                  ...
                  labels: {
                    placeholder: "Ara...",
                    searchTitle: "Tablo içinde ara", 
                    perPage: "Sayfa Başı",
                    pageTitle: "Sayfa {page}",
                    noRows: "Tabloda veri bulunamadı",
                    noResults: "Arama sorgunuza uygun sonuç bulunamadı",
                    info: "{start} - {end} arası {rows} kayıt gösteriliyor", 
                  },
                  template: (t, e) =>
                    `<div class='${t.classes.top}'>\n    ${
                      t.paging && t.perPageSelect
                        ? `<div class='${t.classes.dropdown}'>\n            <label>\n                <select class='${t.classes.selector} form-control'></select>\n            </label>\n        </div>`
                        : ""
                    }\n    ${
                      t.searchable
                        ? `<div class='${
